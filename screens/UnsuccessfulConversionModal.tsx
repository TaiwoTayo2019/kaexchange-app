...
export default function UnsuccessfulConversionModal({ visible, onClose }: any) {
  return (
    <View style={styles.overlay}>
      <View style={styles.modal}>
        ...
        <Text style={styles.title}>Conversion Unsuccessful</Text>
        <Text style={styles.subtitle}>
          We were unable to complete currency conversion at this time, kindly confirm that you have enough balance in your accounts.
        </Text>
...
const styles = StyleSheet.create({
  ...
  errorIcon: { width: 140, height: 140, backgroundColor: '#ef4444', borderRadius: 999, alignItems: 'center', justifyContent: 'center' },
