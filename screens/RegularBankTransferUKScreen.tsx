...
export default function RegularBankTransferUKScreen() {
  return (
    <View style={styles.container}>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        <Text style={styles.subtitle}>Send money to this account (GBP)</Text>

        <View style={styles.detailCard}>
          <View style={styles.row}>
            <Text style={styles.label}>Bank name</Text>
            <Text style={styles.value}>Barclays Bank</Text>
          </View>
          <View style={styles.row}>
            <Text style={styles.label}>Sort code</Text>
            <Text style={styles.value}>20-18-33</Text>
          </View>
          <View style={styles.row}>
        ...
        <Text style={styles.note}>Transfer usually reflects within 2 hours</Text>
      </ScrollView>
    </View>
  );
}
