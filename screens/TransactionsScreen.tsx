...
const styles = StyleSheet.create({
  ...
  dateText: { fontSize: 15, fontWeight: '700', color: '#0d0d1a' },
  ...
  filterButton: { backgroundColor: '#00d4a0', height: 62, borderRadius: 999, alignItems: 'center', justifyContent: 'center', marginTop: 30 },
