      ...
      <View style={styles.formCard}>
        ...
        <View style={styles.amountRow}>
          ...
          <TouchableOpacity style={styles.currencyPill} onPress={() => setShowYouSendModal(true)}>
            <Text style={styles.flag}>{currencies.find(c => c.code === youSendCurrency)?.flag}</Text>
      ...
      <View style={styles.paymentSection}>
        ...
        <View style={styles.paymentRow}>
          <View style={styles.paymentInfo}>
            ...
            <Text style={styles.available}>200.00 {youSendCurrency} available</Text>
          </View>
        </View>
      </View>
...
const styles = StyleSheet.create({
  ...
  formCard: { backgroundColor: '#ffffff', borderRadius: 24, padding: 24, marginHorizontal: 24, marginBottom: 24 },
  ...
  currencyPill: { flexDirection: 'row', alignItems: 'center', backgroundColor: '#f4f4f8', paddingHorizontal: 16, paddingVertical: 12, borderRadius: 999 },
  flag: { fontSize: 28, marginRight: 8 },
  currencyCode: { fontSize: 20, fontWeight: '700' },

  paymentSection: { backgroundColor: '#ffffff', borderRadius: 24, padding: 24, marginHorizontal: 24, marginBottom: 40 },
  ...
  continueButton: { backgroundColor: '#00d4a0', marginHorizontal: 24, height: 62, borderRadius: 999, alignItems: 'center', justifyContent: 'center' },
